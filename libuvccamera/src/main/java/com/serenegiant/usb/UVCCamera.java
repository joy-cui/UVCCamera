...
private static String[] librarySo={"jpeg-turbo1500","usb100","uvc","UVCCamera"};
	private static boolean isLoaded;
	static {
		if (!isLoaded) {

			for(int i=0;i<librarySo.length;i++) {
				Log.e("","加载....."+librarySo[i]+"...start");
				System.loadLibrary(librarySo[i]);
				Log.e("","加载....."+librarySo[i]+"...end");
			}
			isLoaded = true;
		}
	}
    ...
    public UVCCamera() {
    	...
    	Log.e("","UVCCamera....nativeCreate..."+mNativePtr);
    	mSupportedSize = null;
	}
	public synchronized void open(final UsbControlBlock ctrlBlock) {
		int result = -2;
		Log.e("","UVCCamera....open..."+ctrlBlock.getDeviceName());
		StringBuilder sb = new StringBuilder();
		try {
			mCtrlBlock = ctrlBlock.clone();

			Log.e("","UVCCamera....open.22.."+ctrlBlock.getDeviceName());
			...
			Log.e(TAG,"调用nativeConnect返回值："+result);
...
//
//		}
//		Log.e("","UVCCamera....open ..result...."+result);
//    	if (mNativePtr != 0 && TextUtils.isEmpty(mSupportedSize)) {
//    		mSupportedSize = nativeGetSupportedSize(mNativePtr);
//    	}
//		nativeSetPreviewSize(mNativePtr, DEFAULT_PREVIEW_WIDTH, DEFAULT_PREVIEW_HEIGHT,
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
    ...
    public synchronized void startPreview() {
    	if (mCtrlBlock != null) {
			Log.e("","deviceList...startPreview:"+mNativePtr);
